...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.pingPong = channel.unary_unary(
                '/com.example.grpc.PingPongService/pingPong',
...
def add_PingPongServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.example.grpc.PingPongService', rpc_method_handlers)
...
class PingPongService(object):
    ...
    def pingPong(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.example.grpc.PingPongService/pingPong',
